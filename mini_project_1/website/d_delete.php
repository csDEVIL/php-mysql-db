...
$query = "DELETE FROM desktop where";
$var=$_POST['d_name'];
if ($var!="")
  {   $query= $query." name='$_POST[d_name]'";}
$var=$_POST['d_manufacturer'];
if ($var!="")
  {   if ($query=="DELETE FROM desktop where")
...
{ echo "<h2 style='color:#39B4E6'><center><b>Deskops deleted successfully.</b></center></h2>" ;}
else{echo "<h2 style='color:#FC0404'><center><b>Error!No Desktop got deleted.</b></center></h2>" ;}	
