...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Manufacture DELETE</title>
...
$query = "DELETE FROM manufacturer where";
...
$var=$_POST['m_country'];
if ($var!="")
  {   if ($query=="DELETE FROM manufacturer where")
...
if($conn->query($query))
{ echo "<h2 style='color:#39B4E6'><center><b>Companies deleted successfully.</b></center></h2>" ;}
else{echo "<h2 style='color:#FC0404'><center><b>Error!No Company got deleted.</b></center></h2>" ;}	
