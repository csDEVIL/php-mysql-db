...
#rcorners1 {
	...
	<form action="d_search.php" method="POST">
                <div class="" width="%">
                    ...
                    <input class="w3-input w3-border" type="text" name="d_name" placeholder="Desktop Name">
                </div><br>   
				<div class="" width="50%">
                    <label>Manufacturer</label>
                    <input class="w3-input w3-border" type="text" name="d_manufacturer" placeholder="Manufacturer">
                </div><br>
                <div class="" width="50%">
                    <label>Minimum Ram</label>
                    <input class="w3-input w3-border" type="text" name="d_ram" placeholder="in GB">
				</div><br>	
                <div class="" width="50%">
                    <label>Minimum HDD</label>
                    <input class="w3-input w3-border" type="text" name="d_hdd" placeholder="in GB">
				</div><br>	
                <div class="" width="50%">
                    <label>Minimum SSD</label>
                    <input class="w3-input w3-border" type="text" name="d_ssd" placeholder="in GB">
				</div><br>				
                <div class="" width="50%">
                    <label>Operating System</label>
                    <input class="w3-input w3-border" type="text" name="d_os" placeholder="os type">
				</div><br>
				<div class="" width="50%">
                    <label>CPU</label>
                    <input class="w3-input w3-border" type="text" name="d_cpu" placeholder="processor name">
				</div><br>		
	            <div class="" width="50%">
                    <label>Maximum Price</label>
                    <input class="w3-input w3-border" type="text" name="d_price" placeholder="in INR">
				</div><br>
		   ...
		   <form action="d_add.php" method="POST">
				...
				<div class="" width="50%">
                    <label>GPU</label>
                    <input class="w3-input w3-border" type="text" name="d_gpu" placeholder="gpu name">
				</div><br>
	            <div class="" width="50%">
                    <label>Price</label>
                    <input class="w3-input w3-border" type="text" name="d_price" placeholder="in INR">
